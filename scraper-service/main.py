...
def get_squad_players(club_url, year):
    ...
    try:
        ...
        for row in rows:
            ...
            # Position (Nested in the player name table)
            # Structure: <td> <table> <tr> <td> Position </td> </tr> </table> </td>
            ...
            if val_match:
                ...
                if 'm' in market_value_text.lower():
                    val_int = int(val_float * 1000000)
                elif 'k' in market_value_text.lower():
