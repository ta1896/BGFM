...
<x-app-layout>
    ...
    <form method="POST" action="{{ route('lineups.update', $lineup) }}" class="space-y-4">
        @csrf
        @method('PUT')
        ...
        <div class="flex flex-wrap gap-2">
            <button class="sim-btn-primary" type="submit">Aufstellung speichern</button>
            <a href="{{ route('lineups.show', $lineup) }}" class="sim-btn-muted">Zurueck</a>
        </div>
    </form>
</x-app-layout>
