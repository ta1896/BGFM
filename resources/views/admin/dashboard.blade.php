<x-app-layout>
    ...
    <section class="grid gap-4 xl:grid-cols-2">
        ...
        <article class="sim-card p-5">
            <p class="sim-section-title">Admin Hinweis</p>
            <p class="mt-3 text-sm text-slate-300">
                Im ACP kannst du globale Daten bearbeiten, unabhaengig vom eigenen User.
            </p>
        </article>
    </section>
                ...
                @foreach ($latestClubs as $club)
                    <div class="sim-card-soft flex items-center justify-between px-3 py-2">
                        <div>
                            ...
                            <p class="text-xs text-slate-400">Owner: {{ $club->user->name }}</p>
                        </div>
