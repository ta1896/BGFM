            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-slate-500 text-sm font-bold uppercase tracking-widest mt-1">Verwaltung der Spielzeiträume</p>
                    </div>
                    <Link 
                        ...
                        <table className="w-full text-left">
                            <thead>
                                <tr className="border-b border-slate-800 bg-slate-900/50">
                                    <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-slate-500">Saison Name</th>
                                    <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-slate-500">Zeitraum</th>
                                    <th className="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-slate-500 text-center">Aktuelle Saison</th>
                                    <th className="px-6 py-4"></th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-slate-800/50">
                                {seasons.map((season) => (
                                    <tr key={season.id} className="hover:bg-slate-800/20 transition-colors group">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-2 text-sm text-slate-300 font-medium">
                                                <ClockClockwise size={16} className="text-slate-500" />
                ...
                {seasons.length === 0 && (
                    <div className="sim-card p-12 text-center">
                        ...
                        <p className="text-slate-500 font-bold italic">Keine Saisons angelegt.</p>
                    </div>
                )}
            </div>
