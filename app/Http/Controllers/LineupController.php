...
class LineupController extends Controller
{
    ...
    ): View
    {
        ...
        return view('lineups.edit', [
            ...
            'tacticalStyle' => $draft['tactical_style'] ?? ($lineup->tactical_style ?? 'balanced'),
    ...
    public function update(Request $request, Lineup $lineup, FormationPlannerService $planner): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'notes' => ['nullable', 'string', 'max:1000'],
            'is_active' => ['sometimes', 'boolean'],
            'tactical_style' => ['nullable', 'in:balanced,offensive,defensive,counter'],
            'attack_focus' => ['nullable', 'in:left,center,right'],
        ...
        $lineup->update([
            'name' => $validated['name'],
            'formation' => $formation,
            'tactical_style' => $validated['tactical_style'] ?? 'balanced',
